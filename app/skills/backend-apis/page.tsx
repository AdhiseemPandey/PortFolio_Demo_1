...
const BackendAPIsPage = () => {
  const technologies = [
    ...
    },
    {
      ...
      webThreeIntegration:
        "Storing off-chain data for Web3 applications including user profiles, transaction history, and NFT metadata.",
    },
    {
      name: "PostgreSQL",
      description:
      ...
      webThreeIntegration:
        "Ideal for financial Web3 applications requiring complex queries, analytics, and reliable transaction data.",
    },
    {
      name: "The Graph",
      description:
        "Decentralized protocol for indexing and querying blockchain data, enabling efficient data access for dApps.",
      ...
      webThreeIntegration:
        "Core infrastructure for Web3 applications requiring fast, reliable access to blockchain data.",
    },
  ...
  return (
    <div className="container mx-auto px-6 py-20">
      <div className="mb-12">
        <Link
          href="/skills"
          className="inline-flex items-center gap-2 text-gray-300 hover:text-[var(--color-primary)] transition-colors mb-6"
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">{tech.webThreeIntegration}</p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {tech.useCases.map((useCase) => (
                      <div
                        key={useCase}
                        className="p-3 bg-slate-700/50 rounded-lg border border-gray-600"
                      >
