...
import { ArrowLeft, Database, Github, ExternalLink } from "lucide-react";
...
const BackendProjectsPage = () => {
  const projects = [
    {
      ...
      description: "High-performance API gateway for multiple blockchain networks with rate limiting, caching, and real-time data aggregation.",
    ...
    {
      id: 2,
      title: "DeFi Data Aggregator",
      description: "Microservice architecture for aggregating DeFi protocol data from multiple sources with GraphQL API and real-time updates.",
      image: "https://images.pexels.com/photos/5380664/pexels-photo-5380664.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["Node.js", "GraphQL", "PostgreSQL", "The Graph", "WebSocket"],
      github: "#",
      live: "#",
      featured: true
    },
    {
      id: 3,
      title: "Smart Contract Indexer",
      description: "Event indexing service for Ethereum smart contracts with real-time monitoring and historical data analysis.",
      image: "https://images.pexels.com/photos/7567521/pexels-photo-7567521.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["Node.js", "Web3.js", "MongoDB", "Bull Queue", "Express"],
      github: "#",
      live: "#",
      featured: false
    },
    {
      ...
      description: "Payment processing backend supporting multiple cryptocurrencies with webhook notifications and transaction verification.",
      image: "https://images.pexels.com/photos/7567440/pexels-photo-7567440.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["Node.js", "Ethers.js", "PostgreSQL", "Stripe", "JWT"],
      github: "#",
      live: "#",
      featured: false
    }
  ...
  return (
    <div className="container mx-auto px-6 py-20">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-xl text-gray-300">
              Server-side applications, APIs, and blockchain infrastructure
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Featured Projects */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-8">Featured Backend Projects</h2>
      ...
      {/* Other Projects */}
      <div>
        <h2 className="text-2xl font-bold text-white mb-8">Other Backend Projects</h2>
