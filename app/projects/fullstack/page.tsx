...
const FullStackProjectsPage = () => {
  const projects = [
    {
      ...
      description: "Complete lending and borrowing platform with smart contracts, React frontend, and Node.js backend. Features collateral management and liquidation.",
      image: "https://images.pexels.com/photos/7567443/pexels-photo-7567443.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["React", "Node.js", "Solidity", "PostgreSQL", "Web3.js"],
      github: "#",
      live: "#",
      featured: true
    },
    {
      ...
      description: "Full-featured cryptocurrency exchange with order book, trading engine, user management, and real-time market data.",
      image: "https://images.pexels.com/photos/7567486/pexels-photo-7567486.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["Next.js", "Express", "MongoDB", "WebSocket", "Ethers.js"],
      github: "#",
      live: "#",
      featured: true
    },
    {
      ...
      description: "Complete NFT ecosystem with minting, trading, auctions, and royalty distribution. Includes creator dashboard and analytics.",
      image: "https://images.pexels.com/photos/7567521/pexels-photo-7567521.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["React", "Node.js", "IPFS", "Solidity", "MongoDB"],
      github: "#",
      live: "#",
      featured: false
    },
    {
      ...
      description: "Comprehensive DAO platform with proposal creation, voting, treasury management, and member governance features.",
      image: "https://images.pexels.com/photos/7567440/pexels-photo-7567440.jpeg?auto=compress&cs=tinysrgb&w=800",
      tech: ["Next.js", "Express", "PostgreSQL", "Solidity", "The Graph"],
      github: "#",
      live: "#",
      featured: false
    }
  ...
  return (
    <div className="container mx-auto px-6 py-20">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-xl text-gray-300">
              Complete web applications with frontend, backend, and blockchain integration
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Featured Projects */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-white mb-8">Featured Full Stack Projects</h2>
      ...
      {/* Other Projects */}
      <div>
        <h2 className="text-2xl font-bold text-white mb-8">Other Full Stack Projects</h2>
